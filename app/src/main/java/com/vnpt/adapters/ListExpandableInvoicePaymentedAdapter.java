...
public class ListExpandableInvoicePaymentedAdapter extends BaseExpandableListAdapter {

    private LayoutInflater mInflater;
    private Context mContext;
    private ArrayList<ItemDebit> parents = new ArrayList<>();
    OnEventControlListener mListener;

    public ListExpandableInvoicePaymentedAdapter(Context context, OnEventControlListener listener) {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded,
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.item_list_debit_paymented, null);
    ...
    private void setDataParentViews(final int posi, final ItemDebit object, final ViewParentHolder holder) {
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild,
                             View convertView, ViewGroup parentView) {
        final ItemDebit parent = parents.get(groupPosition);
//        final ServiceDebit child = parent.getItemInvoice().get(childPosition);
    ...
    void setDataChildViews(int groupPosition, int childPosition, ItemDebit itemParent, final ViewChildHolder holder) {
//        ListServicesAdapter adapter = new ListServicesAdapter(mContext, itemParent.getItemInvoice());
//        double sumPrice = itemParent.getTotalPrice();
//        adapter.notifyDataSetChanged();
//        holder.listDataService.setAdapter(adapter);
//        holder.txtNumberInvoice.setText(""+itemParent.getNumber_no());
//        double tax = itemParent.getTax();
...
//        holder.txtContentConsume.setText("" + DateTimeUtil.getCurrentMonth(itemParent.getUpdate_time(),Common.DATETIME_FORMAT_PATTERN_1));
//        holder.listDataService.setScrollContainer(false);
    }

    @Override
    public ItemDebit getChild(int groupPosition, int childPosition) {
...
//            size = parents.get(groupPosition).getChildren().size();
        final ItemDebit parent = parents.get(groupPosition);
//        if (parent.getArrChildren() != null)
//            size = parent.getArrChildren().size();
//        return size;
        return 1;
    }
    ...
    @Override
    public ItemDebit getGroup(int groupPosition) {
