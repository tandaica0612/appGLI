...
public class BluetoothPrintService {
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice device, final String socketType) {
        ...
        Message msg = mHandler.obtainMessage(BluetoothPrinterActivity.MESSAGE_DEVICE_NAME);
        Bundle bundle = new Bundle();
        bundle.putString(BluetoothPrinterActivity.DEVICE_NAME, device.getName());
        msg.setData(bundle);
    ...
    public void write(byte[] out) {
        ...
        synchronized (this) {
            if (mState != STATE_CONNECTED) {
                ...
                Message msg = mHandler.obtainMessage(BluetoothPrinterActivity.MESSAGE_TOAST);
                Bundle bundle = new Bundle();
                bundle.putInt(BluetoothPrinterActivity.TOAST, R.string.not_connected);
                msg.setData(bundle);
                mHandler.sendMessage(msg);
    ...
    private void connectionFailed() {
        ...
        Message msg = mHandler.obtainMessage(BluetoothPrinterActivity.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putInt(BluetoothPrinterActivity.TOAST, R.string.connect_fail);
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    ...
    private void connectionLost() {
        ...
        Message msg = mHandler.obtainMessage(BluetoothPrinterActivity.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putInt(BluetoothPrinterActivity.TOAST, R.string.connect_lost);
        msg.setData(bundle);
        mHandler.sendMessage(msg);
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    mHandler.obtainMessage(BluetoothPrinterActivity.MESSAGE_READ, bytes, -1, rcvData).sendToTarget();
                } catch (IOException e) {
