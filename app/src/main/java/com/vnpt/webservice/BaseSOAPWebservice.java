...
import static com.vnpt.common.ConstantsApp.URL_SERVER_SOAP;


public abstract class BaseSOAPWebservice {

//    public static String URL_SERVER_SOAP = "https://blaihccongthaadmindemo.vnpt-invoice.com.vn";
    private static final String TAG = "BaseSOAPWebservice";
    private static final String NAMESPACE = "http://tempuri.org/";

    private static String URL_PUBLISHSERVICE = URL_SERVER_SOAP+"/publishservice.asmx?wsdl";
    ...
    private static String URL_HOTELSERVICE = URL_SERVER_SOAP+"/hotelservice.asmx?wsdl";
    private static String URL3_X2INVOICESERVICE =URL_SERVER_SOAP+"/x2invoiceservice.asmx?WSDL";
