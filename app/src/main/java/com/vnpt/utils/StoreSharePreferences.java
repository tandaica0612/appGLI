...
public class StoreSharePreferences {
	...
	private final static String NAME_PREF = "HDDT_STAFF";
	private static StoreSharePreferences instance;

	private SharedPreferences sharedPreferences;

	private StoreSharePreferences(Context context) {
	 ...
	 * @return
	 */
	public static synchronized StoreSharePreferences getInstance(Context context) {
		if (instance == null) {
			instance = new StoreSharePreferences(context);
		}
		return instance;
	}
